...
3. Treat the ticket as under-specified when it lacks concrete acceptance criteria, scope, key assumptions, or contains vague language such as "and more", "etc.", "fix weirdness", or similar open-ended wording.
